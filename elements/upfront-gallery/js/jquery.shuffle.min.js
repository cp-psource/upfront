...
void 0===window.Modernizr&&(window.Modernizr=function(t,e,i){function n(t){m.cssText=t}function s(t,e){return typeof t===e}function r(t,e){return!!~(""+t).indexOf(e)}function o(t,e){for(var n in t){var s=t[n];if(!r(s,"-")&&m[s]!==i)return"pfx"!=e||s}return!1}function a(t,e,n){for(var r in t){var o=e[t[r]];if(o!==i)return!1===n?t[r]:s(o,"function")?o.on(n||e):o}return!1}function l(t,e,i){var n=t.charAt(0).toUpperCase()+t.slice(1),r=(t+" "+_.join(n+" ")+n).split(" ");return s(e,"string")||s(e,"undefined")?o(r,e):a(r=(t+" "+g.join(n+" ")+n).split(" "),e,i)}var u,c,f={},d=e.documentElement,h="modernizr",p=e.createElement(h),m=p.style,y=" -webkit- -moz- -o- -ms- ".split(" "),v="Webkit Moz O ms",_=v.split(" "),g=v.toLowerCase().split(" "),C={},b=[],$=b.slice,w=function(t,i,n,s){var r,o,a,l,u=e.createElement("div"),c=e.body,f=c||e.createElement("body");if(parseInt(n,10))for(;n--;)(a=e.createElement("div")).id=s?s[n]:h+(n+1),u.appendChild(a);return r=["&#173;",'<style id="s',h,'">',t,"</style>"].join(""),u.id=h,(c?u:f).innerHTML+=r,f.appendChild(u),c||(f.style.background="",f.style.overflow="hidden",l=d.style.overflow,d.style.overflow="hidden",d.appendChild(f)),o=i(u,t),c?u.parentNode.removeChild(u):(f.parentNode.removeChild(f),d.style.overflow=l),!!o},x={}.hasOwnProperty;for(var z in c=s(x,"undefined")||s(x.call,"undefined")?function(t,e){return e in t&&s(t.constructor.prototype[e],"undefined")}:function(t,e){return x.call(t,e)},Function.prototype.bind||(Function.prototype.bind=function(t){var e=this;if("function"!=typeof e)throw new TypeError;var i=$.call(arguments,1),n=function(){if(this instanceof n){var s=function(){};s.prototype=e.prototype;var r=new s,o=e.apply(r,i.concat($.call(arguments)));return Object(o)===o?o:r}return e.apply(t,i.concat($.call(arguments)))};return n}),C.csstransforms=function(){return!!l("transform")},C.csstransforms3d=function(){var t=!!l("perspective");return t&&"webkitPerspective"in d.style&&w("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",(function(e,i){t=9===e.offsetLeft&&3===e.offsetHeight})),t},C.csstransitions=function(){return l("transition")},C)c(C,z)&&(u=z.toLowerCase(),f[u]=C[z](),b.push((f[u]?"":"no-")+u));return f.addTest=function(t,e){if("object"==typeof t)for(var n in t)c(t,n)&&f.addTest(n,t[n]);else{if(t=t.toLowerCase(),f[t]!==i)return f;e="function"==typeof e?e():e,d.className+=" "+(e?"":"no-")+t,f[t]=e}return f},n(""),p=null,f._version="2.8.3",f._prefixes=y,f._domPrefixes=g,f._cssomPrefixes=_,f.mq=function(e){var i,n=t.matchMedia||t.msMatchMedia;return n?n(e)&&n(e).matches||!1:(w("@media "+e+" { #"+h+" { position: absolute; } }",(function(e){i="absolute"==(t.getComputedStyle?getComputedStyle(e,null):e.currentStyle).position})),i)},f.testProp=function(t){return o([t])},f.testAllProps=l,f.testStyles=w,f.prefixed=function(t,e,i){return e?l(t,e,i):l(t,"pfx")},d.className=d.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+" js "+b.join(" "),f}(this,this.document)),function(t,e){var i,n=t.jQuery||t.Cowboy||(t.Cowboy={});n.throttle=i=function(t,i,s,r){var o,a=0;function l(){var n=this,l=+new Date-a,u=arguments;function c(){a=+new Date,s.apply(n,u)}r&&!o&&c(),o&&clearTimeout(o),r===e&&l>t?c():!0!==i&&(o=setTimeout(r?function(){o=e}:c,r===e?t-l:t))}return"boolean"!=typeof i&&(r=s,s=i,i=e),n.guid&&(l.guid=s.guid=s.guid||n.guid++),l},n.debounce=function(t,n,s){return s===e?i(t,n,!1):i(t,s,!1!==n)}}(this),
/**
