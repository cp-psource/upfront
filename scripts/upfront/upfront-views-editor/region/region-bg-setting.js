	...
	define([
		...
		return ModalBgSetting.extend({
				...
				var me = this,
					...
					region_name = new Fields.Text({
						...
						blur: function () {
							...
							title = this.get_value().replace(/[^A-Za-z0-9\s_-]/g, '').trim(), // strict filtering to prevent unwanted character
			...
			get_region_css_styles: function (model) {
				...
				return {
					styles: Upfront.Application.cssEditor.get_style_element().html().trim(),
