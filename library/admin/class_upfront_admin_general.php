			...
			<div class="upfront-col-right">
				<div class="postbox-container helpful-resources">
					<div class='postbox'>
						...
						<div class="inside">
							<div class="upfront-debug-block">
								<a target="_blank" href="https://github.com/cp-psource/upfront/wiki" class="documentation">Upfront Documentation</a> <a target="_blank" href="https://cp-psource.github.io/upfront-builder/" class="documentation">Building Upfront Themes</a>
							</div>
							<div class="upfront-debug-block">
								...
								<ul>
									...
									<li><a href='https://cp-psource.github.io/upfront/tutorial-tweaking.html' target="_blank"><?php esc_html_e("Upfront Part 4: Tweaking Elements with Custom Code", Upfront::TextDomain) ?></a></li>
									<li><a href='https://cp-psource.github.io/upfront/tutorial-plugins.html' target="_blank"><?php esc_html_e("Upfront Part 5: Adding Plugins and Styling Gravity Forms", Upfront::TextDomain) ?></a></li>
									<li><a href='https://cp-psource.github.io/upfront/tutorial-responsive.html' target="_blank"><?php esc_html_e("Upfront Part 6: Creating Responsive Websites", Upfront::TextDomain) ?></a></li>
									<li><a href='https://cp-psource.github.io/upfront/tutorial-content.html' target="_blank"><?php esc_html_e("Upfront Part 7: Working With Pages and Posts", Upfront::TextDomain) ?></a></li>
								</ul>
							</div>
							<div class="upfront-debug-block">
								<h4><?php _e("PSOURCE Help", Upfront::TextDomain) ?></h4>
								<a class="upfront_button visit-forum" href="https://github.com/cp-psource/upfront/discussions" target="_blank"><?php esc_html_e("Visit Forums", Upfront::TextDomain) ?></a> <a class="upfront_button" href="https://github.com/cp-psource/upfront/issues" target="_blank"><?php esc_html_e("Bug Report", Upfront::TextDomain) ?></a>
							</div>
						</div>
					</div>
				</div>
