...
class Upfront_Permissions {
	...
	public function get_capability_labels () {
		...
		return apply_filters('upfront-access-permissions-labels', array(
			...
			self::BOOT => __('Kann auf den Upfront-Editor-Modus zugreifen', Upfront::TextDomain ),
			self::LAYOUT_MODE => __('Kann UpFront Layouts anpassen', Upfront::TextDomain ),
			self::SINGLEPOST_LAYOUT_MODE => __('Kann das Layout einzelner Beiträge ändern', Upfront::TextDomain ),
			self::SINGLEPAGE_LAYOUT_MODE => __('Kann das Seitenlayout ändern', Upfront::TextDomain ),
			self::HOME_LAYOUT_MODE => __('Kann das Homepage-Layout ändern', Upfront::TextDomain ),
			self::ARCHIVE_LAYOUT_MODE => __('Kann das Archivlayout ändern', Upfront::TextDomain ),
			self::UPLOAD => __('Kann Medien hochladen', Upfront::TextDomain ),
			self::MODIFY_ELEMENT_PRESETS => __('Kann Elementvoreinstellungen erstellen/ändern', Upfront::TextDomain ),
			self::DELETE_ELEMENT_PRESETS => __('Kann Elementvoreinstellungen löschen', Upfront::TextDomain ),
			self::SWITCH_ELEMENT_PRESETS => __('Kann zwischen Elementvoreinstellungen wechseln', Upfront::TextDomain ),
			self::OPTIONS => __('Kann globale Optionen <p class="description">(Designfarben, Kommentare usw.)</p> ändern/speichern', Upfront::TextDomain ),
			self::CREATE_POST_PAGE => __('Kann Beiträge und Seiten mit UpFront erstellen', Upfront::TextDomain ),
			self::EDIT => __('Kann die vorhandenen Beiträge und Seiten von jedem bearbeiten', Upfront::TextDomain ),
			self::EDIT_OWN => __('Kann eigene vorhandene Beiträge und Seiten bearbeiten', Upfront::TextDomain ),
			self::EMBED => __('Kann Einbettungen verwenden (Code El, Medieneinbettungen)', Upfront::TextDomain ),
			self::RESPONSIVE_MODE => __('Kann Layouts im Responsive-Modus eingeben und ändern', Upfront::TextDomain ),
			self::MODIFY_RESTRICTIONS => __('Kann Benutzer-Rechte anpassen', Upfront::TextDomain ),
			self::SEE_USE_DEBUG => __('Kann Debug-Steuerelemente sehen/verwenden', Upfront::TextDomain ),
		));
	}
