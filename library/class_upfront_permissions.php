...
class Upfront_Permissions {
	...
	public function get_capability_labels () {
		...
		return apply_filters('upfront-access-permissions-labels', array(
			...
			self::BOOT => __('Zugriff auf Upfront-Editor-Modus', Upfront::TextDomain ),
			self::LAYOUT_MODE => __('Kann UpFront Layouts ändern', Upfront::TextDomain ),
			self::SINGLEPOST_LAYOUT_MODE => __('Kann Layout einzelner Posts ändern', Upfront::TextDomain ),
			self::SINGLEPAGE_LAYOUT_MODE => __('Kann Seitenlayout ändern', Upfront::TextDomain ),
			self::HOME_LAYOUT_MODE => __('Kann Homepage-Layout ändern', Upfront::TextDomain ),
			self::ARCHIVE_LAYOUT_MODE => __('Kann Archivlayout ändern', Upfront::TextDomain ),
			...
			self::OPTIONS => __('Kann globale Optionen ändern/speichern <p class="description">(Designfarben, Kommentare usw.)</p>', Upfront::TextDomain ),
			...
			self::EDIT_OWN => __('Kann eigene bestehende Beiträge & Seiten bearbeiten', Upfront::TextDomain ),
			self::EMBED => __('Kann Embeds verwenden (Code El, Media Embeds)', Upfront::TextDomain ),
			self::RESPONSIVE_MODE => __('Kann Layouts im Responsivmodus einstellen und ändern', Upfront::TextDomain ),
			self::MODIFY_RESTRICTIONS => __('Kann Benutzereinschränkungen ändern', Upfront::TextDomain ),
